...
Das Programm ist identisch zum Programm `eigenmoden_stabwerk.py`
mit der einzigen Ausnahme, dass die Steifigkeit der
Querverstrebungen um einen Faktor 1000 erhöht wurden.
"""
...
# Ezeuge eine Liste der animierten Grafikobjekte jeder Eigenmode.
plots = []
